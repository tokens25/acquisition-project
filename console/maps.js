  ...
  var MAPS = {
    ...
    flowLandingPage: { vb: '0 0 80 220', parts: {
      ...
      'out-of-area notice': [8,132,64,4],
      'out-of-area notice line': [10,133,60,4], 'out-of-area note': [8,136,64,4],
      'out-of-area button': [8,141,64,6],
      'multiview block': [4,96,72,26], 'article card': [6,97,68,24],
      'article still': [8,99,64,10], 'article words': [8,110,64,9],
      'article prefix': [8,110,64,3], 'article kind': [13,110,14,3],
      'article pill holder': [30,110,20,3], 'article pill': [32,110,18,3],
      'article heading': [8,114,64,3], 'article body': [8,117,64,3],
      'article button': [8,121,64,4],
      'providers block': [4,126,72,44],
      'providers words': [8,127,64,10], 'providers heading': [8,127,64,6],
      'providers body': [8,134,64,4],
      'provider grid': [4,140,72,24], 'provider tile': [4,140,34,7],
      'provider logo': [10,142,22,3],
      'providers note': [8,165,64,3], 'providers button': [8,169,64,5],
      'supported devices block': [4,196,72,26], 'supported devices heading': [8,197,64,4],
      'supported devices rule': [8,198,10,2], 'supported devices body': [8,203,64,22],
      'supported devices wall': [8,203,64,18],
      'supported devices row': [8,203,64,4], 'supported device logo': [8,203,14,4],
      'supported devices note': [8,222,64,4], 'supported devices link': [24,224,32,2],
      'features block': [4,226,72,60],
      'features words': [8,227,64,8],
      'features eyebrow': [8,227,64,3],
      'features heading': [8,231,64,5],
      'features rows': [8,237,64,44],
      'feature row': [8,237,64,11],
      'feature picture': [8,237,14,11],
      ...
      'features button': [8,282,64,5],
      'image card block': [4,196,72,30], 'image card': [4,196,72,30],
      'image card picture': [4,196,72,22], 'image card foot': [8,214,64,10],
      'image card words': [8,214,64,5], 'image card heading': [8,214,64,3],
      'image card body': [8,217,64,2], 'image card button': [8,220,64,4],
      'text block': [4,174,72,18], 'text block heading': [8,175,64,7],
      'text block gold line': [8,180,64,3], 'text block body': [8,184,64,7],
      'questions block': [4,208,72,10],      'footer': [4,318,72,14], 'footer links': [8,320,64,8],
      'footer link': [8,320,18,3], 'footer line break': [8,324,64,1],
      'footer mark': [30,329,20,3],
      'footer mark letters': [46,329,4,2],
      'FAQ heading': [8,290,64,4], 'FAQ cards': [8,296,64,20],
      'FAQ card': [8,296,64,6], 'FAQ card row': [10,297,60,4],
      'FAQ question': [10,297,52,4], 'FAQ answer': [10,302,60,3],
      'gold half sentence': [30,80,26,4]
    }},
