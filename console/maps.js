  ...
  var MAPS = {
    ...
    panelEdit: { vb: '0 0 80 150', furn: [[6,22,68,18]], parts: {
      ...
      'field row grip': [4,44,3,5], 'team row fields': [22,44,40,12], 'team ground': [22,54,18,4], 'team ground name': [28,54,12,4], 'component grip': [7,47,3,4], 'component shape': [12,45,9,7],
    ...
    flowLandingPage: { vb: '0 0 80 220', parts: {
      ...
      "day block": [0,530,80,40],
      "day date": [4,531,10,10],
      "day label": [4,531,10,3],
      "day number": [5,534,8,5],
      "day month": [5,539,8,2],
      "day games": [18,531,58,38],
      "day game": [18,531,58,18],
      "day game picture": [18,531,58,12],
      "day game timestamp": [19,532,10,3],
      "day game reminder": [70,532,5,5],
      "day game name": [18,544,58,3],
      "day game meta": [18,547,40,3],
