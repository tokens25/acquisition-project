  ...
  var MAPS = {
    ...
    flowLandingPage: { vb: '0 0 80 220', parts: {
      ...
      'team plate': [4,96,16,9], 'team crest': [8,98,8,4], 'team logo': [8,97,8,5],
      'team wash': [4,102,16,3], 'team words': [5,102,10,3],
      'team city': [5,102,8,1], 'team name': [5,103,8,2],
      'team template': [22,96,16,9], 'out-of-area block': [0,108,80,30], 'out-of-area card': [4,110,72,26],
      ...
      'out-of-area entry': [15,125,44,5], 'out-of-area clear': [64,126,5,5],
      ...
      'feature banner block': [4,96,72,26], 'feature banner card': [6,97,68,24],
      'feature banner still': [8,99,64,10], 'feature banner words': [8,110,64,9],
      'feature banner prefix': [8,110,64,3], 'feature banner kind': [13,110,14,3],
      'feature banner pill holder': [30,110,20,3], 'feature banner pill': [32,110,18,3],
      'feature banner heading': [8,114,64,3], 'feature banner body': [8,117,64,3],
      'feature banner button': [8,121,64,4],
      'feature banner list': [8,126,64,6], 'feature banner line': [8,126,64,2],
      'feature banner tick': [8,126,3,2],
      'article top': [6,96,68,8],
      'article prefix': [24,96,28,2], 'article kind': [26,96,12,2],
      'article pill': [40,96,12,2],
      'article top heading': [10,99,60,2], 'article top body': [10,101,60,3],
      'article card': [6,105,68,17],
      'article still': [8,106,64,5], 'article words': [8,112,64,10],
      'article heading': [8,112,64,2], 'article body': [8,114,64,2],
      'article button': [8,116,64,2],
      'article price': [8,115,64,1], 'article amount': [8,115,10,1],
      ...
      'supported devices block': [4,174,72,48], 'supported devices heading': [8,197,64,4],
      'supported devices intro': [8,175,64,7], 'supported devices gold line': [8,180,64,3],
      'supported devices intro body': [8,184,64,7],
      ...
      'image card list': [8,225,64,6], 'image card line': [8,225,64,2],
      'image card tick': [8,225,3,2],
      'image card rail': [4,225,72,12], 'image card clip': [4,225,22,12],
      'image card clip picture': [4,225,22,7], 'image card clip name': [4,233,22,2],
      'image card clip meta': [4,235,22,2],
      ...
      "rail block": [0,336,80,26],
      "rail title": [4,337,50,4],
      ...
      "more subscriptions block": [0,364,80,44],
      "more subscriptions head": [4,365,72,9],
      "more subscriptions heading": [4,365,72,5],
      "more subscriptions body": [4,371,60,3],
      "more subscriptions row": [0,376,80,32],
      "subscription tile": [4,376,26,32],
      "subscription tile picture": [4,376,26,32],
      ...
      "bundles heading": [16,413,48,5],
      "bundles body": [20,419,40,3],
      "bundles row": [0,424,80,36],
      "bundle card": [4,424,28,36],
      "bundle label": [24,424,8,3],
      "bundle name": [6,427,20,3],
      "bundle note": [6,430,24,3],
      "bundle prices": [6,434,24,4],
      "bundle price": [6,434,10,4],
      "bundle old price": [17,435,6,2],
      "bundle saving": [24,435,6,2],
      "bundle term": [6,438,16,3],
      "bundle nights": [6,442,24,10],
      "bundle night": [6,442,24,4],
      "bundle night picture": [6,442,7,4],
      "bundle night words": [14,442,16,4],
      "bundle night name": [14,442,16,2],
      "bundle night when": [14,444,12,2],
      "bundle button": [6,454,24,4],
      "match list block": [0,466,80,60],
      "match list head": [8,467,64,16],
      "match list eyebrow": [24,467,32,3],
      "match list heading": [12,471,56,6],
      "match list button": [26,478,28,5],
      "match list": [4,486,72,40],
      "match day": [4,486,32,4],
      "match card": [4,491,72,12],
      "match teams": [8,492,64,6],
      "match team": [8,492,22,6],
      "match team code": [8,493,8,3],
      "match team flag": [18,492,12,6],
      "match kick-off": [36,493,8,4],
      "match note": [8,499,64,3],
      "card stack": [0,574,80,50],
      "feature card": [4,575,72,14],
      "card number": [8,576,16,6],
      "card heading": [8,581,50,4],
      "card line": [8,581,50,2],
      "feature card body": [8,585,60,3],
      "card button": [8,589,28,5],
      "places block": [0,628,80,44],
      "places head": [4,629,72,12],
      "places eyebrow": [4,629,28,3],
      "places heading": [4,633,44,5],
      "places body": [4,638,68,4],
      "places tabs": [4,644,72,5],
      "places tab": [4,644,14,5],
      "places row": [0,652,80,20],
      "place tile": [4,652,20,20],
      "place picture": [4,652,20,20],
      "place wash": [4,662,20,10],
      "place words": [5,664,18,7],
      "place name": [5,664,18,3],
      "place meta": [5,668,14,3],
      "what's live block": [0,676,80,44],
      "what's live card": [4,677,72,42],
      "what's live copy": [8,679,64,8],
      "what's live heading": [10,679,60,5],
      "what's live body": [10,684,60,3],
      ...
      "what's live crest": [9,698,4,4],
      "what's live team name": [15,699,40,3],
      "what's live league": [62,699,8,3],
      "what's live button": [8,714,64,5],
      "spotlight block": [0,724,80,52],
      "spotlight picture": [0,724,80,26],
      "spotlight wash": [0,738,80,12],
      "spotlight copy": [4,742,72,14],
      "spotlight label": [4,742,12,3],
      "spotlight heading": [4,746,60,5],
      "spotlight body": [4,751,68,5],
      ...
      "fight plan card": [4,791,72,30],
      "fight plan card head": [6,792,68,4],
      "fight plan name": [6,792,24,4],
      "fight plan radio": [70,792,4,4],
      "fight plan note": [6,796,60,3],
      "fight plan price": [6,800,20,5],
      "fight plan unit": [20,801,6,3],
      "fight plan boxed message": [6,806,68,6],
      "fight plan bundle": [6,806,68,7],
      "fight plan bundle name": [6,806,30,3],
      "fight plan bundle price": [6,809,30,4],
      "fight plan old price": [22,810,6,2],
      "fight plan saving": [30,810,8,2],
      "fight plan fight": [6,814,68,6],
      "fight plan fight picture": [6,814,10,6],
      "fight plan fight words": [18,814,56,6],
      "fight plan fight name": [18,814,40,2],
      "fight plan fight date": [18,816,26,2],
      "fight plan fight price": [18,818,16,2],
      "fight plan fight saving": [38,818,10,2],
      "fight plan posters line": [6,822,60,3],
      "fight plan posters": [4,826,72,12],
      "fight plan poster": [6,826,8,12],
      "fight plan poster date": [6,835,8,3],
      "fight plan lines": [6,823,68,10],
      "fight plan line": [6,823,68,3],
      "fight plan more": [26,843,28,3],
      "fight plan button": [4,847,72,5],
