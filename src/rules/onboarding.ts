...
export const SETUP_STEPS = [
  { n: 1, title: 'Card structure', blurb: 'Which parts of a plan card this flow draws.' },
  { n: 2, title: 'Plans', blurb: 'How many, which is promoted, which is chosen.' },
  { n: 3, title: 'Payment', blurb: 'Whether choosing how to pay is its own step.' },
  { n: 4, title: 'Login banner', blurb: 'Whether the login page carries a notice.' },
  { n: 5, title: 'Consents', blurb: 'How many, and which are required.' },
  { n: 6, title: 'Review', blurb: 'What has been described, before any content.' },
] as const
